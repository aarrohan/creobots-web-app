  ...
  return (
    <div className="p-7 border border-white/10 bg-[rgba(52,76,125,0.15)] shadow-[inset_0px_64px_64px_32px_rgba(144,167,216,0.15)] rounded-xl">
      ...
      <h4 className="my-3 text-5xl font-semibold">
        $72<span className="text-sm font-light">/mo.</span>
      </h4>

      <p className="mb-4 text-sm font-light text-white/65">
        Generate up to{" "}
        <span className="font-semibold text-gradient">9,270 thumbnails</span>{" "}
        per year.
      </p>
      ...
      <div className="mt-4 p-5 border border-white/5 bg-white/5 rounded-lg space-y-2.5">
        <div className="flex items-center gap-2">
          <IncludedIcon /> <p className="text-sm">3,090 Coins</p>{" "}
          <Tooltip.Provider>
            <Tooltip.Root>
          ...
          <Tooltip.Provider>
            <Tooltip.Root>
              ...
              >
                You normally receive 3,000 coins anually (250 × 12). With the
                loyalty bonus, your total increases to 3,090 coins.
                <Tooltip.Arrow className="fill-[#fff]" />
              </Tooltip.Content>
            </Tooltip.Root>
          </Tooltip.Provider>
        ...
        <div className="flex items-center gap-2">
          <IncludedIcon /> <p className="text-sm">Dedicated Support</p>{" "}
        </div>
        ...
        <div className="flex items-center gap-2">
          <IncludedIcon />{" "}
          <p className="text-sm">1-Click Video Editor (Coming Soon)</p>{" "}
          <Tooltip.Provider>
            <Tooltip.Root>
              <Tooltip.Trigger asChild>
                <button className="flex text-white/50">
        ...
        <div className="flex items-center gap-2">
          <IncludedIcon />{" "}
          <p className="text-sm">All Generations Remains Private</p>{" "}
          <Tooltip.Provider>
            <Tooltip.Root>
              <Tooltip.Trigger asChild>
                <button className="flex text-white/50">
